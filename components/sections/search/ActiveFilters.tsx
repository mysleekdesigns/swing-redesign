  ...
  return (
    <div className="flex flex-wrap gap-2 mt-4">
      ...
      <button
        ...
        className="inline-flex items-center gap-1 px-3 py-1 bg-muted text-muted-foreground border border-border rounded-full text-sm hover:bg-muted/80 transition-colors"
      >
        Clear All
        <X className="w-3 h-3" />
      </button>
